package com.certiorem.workSelectorAlgoritm.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.certiorem.workSelectorAlgoritm.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.certiorem.workSelectorAlgoritm.model" });
